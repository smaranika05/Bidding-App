...
const Filters = React.memo(({ customersInAscendingOrderByBidAmount, selectedOption }) => {
  ...
  return (
    <div className="flex head-border flex-col sm:flex-row items-stretch sm:items-center justify-between space-y-2 mb-2 px-4 py-2 bg-green-500 rounded-lg shadow-md ">
